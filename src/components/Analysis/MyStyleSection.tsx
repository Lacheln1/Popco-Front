...
const MyStyleSection: React.FC = () => {
  return (
    <section className="pretendard flex">
      <div
        className="mx-1 flex w-full flex-col bg-slate-50 py-5"
        style={{ boxShadow: "0 0px 10px rgba(0, 0, 0, 0.1)" }}
      >
        <div className="flex flex-col text-center text-base md:text-2xl lg:text-3xl">
          <span className="gmarket-medium">내 OTT 시청 스타일은</span>
          <span className="">상위 8.2% 의 #스릴러, 상위 8.3% 의 액션러!</span>
        </div>
        <div className="flex w-full justify-center gap-6 pt-4 md:text-xl lg:text-2xl">
        ...
        <div className="mt-4 flex justify-center break-keep px-1 text-center">
          <span className="break-keep md:text-xl xl:text-2xl">
