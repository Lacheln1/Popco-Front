const AnalysisHeroSection = () => {
  return (
    <div>
      <div className="relative h-[380px] overflow-hidden md:h-[420px]">
        <div
        ...
        <div className="relative mx-auto h-full w-full">
          ...
          <div className="absolute left-1/2 top-32 w-60 -translate-x-1/2 transform md:w-full">
            <h1 className="gmarket-medium text-center text-2xl text-white md:text-3xl">
          ...
          <div className="flex pt-56">
            <div className="mx-auto flex">
              <div className="absolute flex -translate-x-[97px] -translate-y-10 flex-col pt-4 md:-translate-x-60">
                ...
                <img
                  ...
                  alt="텍스트 라인"
                  className="hidden object-cover md:inline md:w-60"
                />
              </div>
              <img
                src="/images/persona/애기액션헌터.png"
                alt="캐릭터이미지"
                className="h-[150px] w-[150px] object-cover md:h-[200px] md:w-[200px] md:pt-10"
              />
            </div>
          </div>
        </div>
      </div>
      <div className="gmarket-medium flex justify-center text-3xl md:mt-8 md:text-4xl">
        애기 액션 헌터
      </div>
    </div>
  );
